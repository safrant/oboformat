...
//	public static final String OIOVOCAB_IRI_PREFIX = "http://www.geneontology.org/formats/oboInOwl#";
	...
	public static final String OIOVOCAB_IRI_PREFIX = "http://purl.obolibrary.org/obo/go.owl#";
	
	public static final String NCItVOCAB_IRI_PREFIX = "http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl#";
...
//		IRI_OIO_hasRelatedSynonym(Obo2OWLConstants.OIOVOCAB_IRI_PREFIX, "hasRelatedSynonym", "has_related_synonym", OboFormatTag.TAG_RELATED.getTag()),
		...
		IRI_OIO_hasBroadSynonym(Obo2OWLConstants.OIOVOCAB_IRI_PREFIX, "FULL_SYN", "FULL_SYN", OboFormatTag.TAG_BROAD.getTag()),
		IRI_OIO_hasNarrowSynonym(Obo2OWLConstants.OIOVOCAB_IRI_PREFIX, "FULL_SYN", "FULL_SYN", OboFormatTag.TAG_NARROW.getTag()),
		IRI_OIO_hasExactSynonym(Obo2OWLConstants.OIOVOCAB_IRI_PREFIX, "FULL_SYN", "FULL_SYN", OboFormatTag.TAG_EXACT.getTag()),
		IRI_OIO_hasRelatedSynonym(Obo2OWLConstants.OIOVOCAB_IRI_PREFIX, "FULL_SYN", "FULL_SYN", OboFormatTag.TAG_RELATED.getTag()),
		IRI_IAO_0000118(Obo2OWLConstants.OIOVOCAB_IRI_PREFIX, "FULL_SYN", "FULL_SYN", OboFormatTag.TAG_SYNONYM.getTag()),
		IRI_IAO_0000115(Obo2OWLConstants.OIOVOCAB_IRI_PREFIX, "DEFINITION", "DEFINITION", OboFormatTag.TAG_DEF.getTag()),
		isDeprecated(Obo2OWLConstants.OIOVOCAB_IRI_PREFIX, "is_obsolete","is_obsolete", OboFormatTag.TAG_IS_OBSELETE.getTag());
